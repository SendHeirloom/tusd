...
import (
	...
	"github.com/sendheirloom/tusd/pkg/gcsstore"
	"github.com/sendheirloom/tusd/pkg/handler"
)

//go:generate mockgen -destination=./gcsstore_mock_test.go -package=gcsstore_test github.com/sendheirloom/tusd/pkg/gcsstore GCSReader,GCSAPI
